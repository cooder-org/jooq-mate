...
public interface Generator {
    ...
    default void output(TypeGeneratorStrategy strategy, String packageName, TypeSpec typeSpec) {
...
class TypeInterfaceGenerator implements Generator {
    ...
    public void generate(TableMeta table) {
        ...
        output(strategy, strategy.interfacePackageName(tableName), ts.build());
    }
...
class TypeRecordGenerator implements Generator {
    ...
    public void generate(TableMeta table) {
        ...
        output(strategy, strategy.recordPackageName(tableName), ts.build());
    }
...
class TypePojoGenerator implements Generator {
    ...
    public void generate(TableMeta table) {
        ...
        output(strategy, strategy.pojoPackageName(tableName), ts.build());
